...
| Benchmarks (week 5) | scan **20.2M**, full decode **17.5M**, whole-market book **3.0M msgs/sec** medians — I/O included, run-to-run within 1.1%; methodology in [docs/benchmarks.md](docs/benchmarks.md) |
| Throughput (parse + book build, full-day replay) | baseline **3.0M msgs/sec** whole-market — CPU-bound in map containers, not I/O (0.09 vs 0.62 GB/s floor); optimization pass targets ≥10M |
